...
//--------------------------------------------------------------------------------------------------
// ToDoApp: Define a constant for the tasks file (tasks.json)
define("TASKS_FILE", "tasks.json");

// ToDoApp: Create a function to load tasks from the tasks.json file
...
// ToDoApp: Create a function to save tasks to the tasks.json file
// This function should take an array of tasks and save it back to the JSON file
function saveTasks(array $tasks) : void {
    file_put_contents(TASKS_FILE, json_encode($tasks, JSON_PRETTY_PRINT));
}

// ToDoApp: Check if the form has been submitted using POST request
...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_POST['task']) && !empty(trim($_POST['task']))){ 
        ...
        // ToDoApp: Handle task deletion (check if a delete action is requested, remove the task from the array, and save)
        // delete a task
        ...
        // ToDoApp: Handle task completion toggle (check if toggle action is requested, update task's done status, and save)
            ...
            <form method="POST">
                <div class="row">
                    ...
                    <div class="column column-25">
                        <button type="submit" class="button-primary">Submit Task</button>
                    </div>
                </div>
            </form>
